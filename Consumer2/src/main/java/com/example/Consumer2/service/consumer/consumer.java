package com.example.Consumer2.service.consumer;


import com.example.Consumer2.domain.FoodOrder;
import com.example.Consumer2.domain.dto.FoodOrderDTO;
import com.example.Consumer2.service.FoodOrderService;
...
public class consumer {
    ...
    @KafkaListener(topicPartitions = { @TopicPartition(topic = orderTopic, partitions = { "1" }) }, groupId = "default")
